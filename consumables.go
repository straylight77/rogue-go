...
var PotionLib = []PotionTemplate{
	{15, 15, "healing", EHealing, 130, 0, false, "You begin to feel better."},
	{15, 30, "strength", EStrength, 150, 0, false, "You feel stronger, what bulging muscles!"},
	{14, 44, "restore strength", ERestore, 120, 0, false, "Hey, this tastes great, it make you feel warm all over."},
	{10, 54, "paralysis", EParalyze, 50, 0, false, "You feel your body seizing up, you can't move!"},
	{8, 62, "confusion", EConfusion, 50, 0, false, "Wait, what's going on here. Huh? What? Who?"},
	{8, 70, "poison", EPoison, 50, 0, false, "You feel very sick now."},
	{6, 76, "monster detection", EDetMonsters, 120, 0, false, "You feel like you are not alone."},
	{6, 82, "detect magic", EDetMagic, 105, 0, false, "You sense the presence of magic."},
	{5, 87, "extra healing", EExtraHealing, 180, 0, false, "You begin to feel much better."},
	{4, 91, "haste", EHaste, 200, 0, false, "Tastes like coffee, everything seems to slow down."},
	{4, 95, "blindness", EBlindness, 50, 0, false, "A cloak of darkness falls around you."},
	{2, 97, "raise level", ELevelUp, 220, 0, false, "You feel more experienced."},
	{2, 99, "truesight", ETruesight, 170, 0, false, "Tastes like slime-mold juice."},
	{1, 100, "thirst quenching", ENothing, 50, 0, false, "Meh, tastes pretty dull."},
}
